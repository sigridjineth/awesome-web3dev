...
(function (Proposal) {
    ...
    (function (Content) {
        ...
        function fromProto(data) {
            switch (data['@type']) {
                case '/cosmos.gov.v1beta1.TextProposal':
                    return proposals_3.TextProposal.fromProto(data);
                case '/cosmos.distribution.v1beta1.CommunityPoolSpendProposal':
                    return proposals_1.CommunityPoolSpendProposal.fromProto(data);
                case '/cosmos.params.v1beta1.ParameterChangeProposal':
                    return proposals_2.ParameterChangeProposal.fromProto(data);
                // case 'upgrade/SoftwareUpgradeProposal':
                // case 'upgrade/CancelSoftwareUpgradeProposal':
            }
        }
