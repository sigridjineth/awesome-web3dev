...
export declare namespace Proposal {
    ...
    namespace Content {
        ...
        type Proto = TextProposal.Proto | CommunityPoolSpendProposal.Proto | ParameterChangeProposal.Proto;
        function fromData(data: Proposal.Content.Data): Proposal.Content;
        function fromProto(data: Proposal.Content.Proto): Proposal.Content;
    }
    enum Status {
        NIL = "",
